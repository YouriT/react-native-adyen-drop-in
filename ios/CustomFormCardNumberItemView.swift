...
internal final class CustomFormCardNumberItemView: FormValueItemView<CustomFormCardNumberItem> {
    
    /// Initializes the form card number item view.
    ///
    /// - Parameter item: The item represented by the view.
    internal required init(item: CustomFormCardNumberItem) {
...
private extension CustomFormCardNumberItemView {
    
    private class CardTypeLogoView: NetworkImageView, Observer {
        
        internal init(cardTypeLogo: CustomFormCardNumberItem.CardTypeLogo) {
